 ...
 *
 * (!) Это наиболее удобный в чтении вариант транслита. Он не совместим с форматом ИКАО, в котором, транслитирируются имена
 *     для банковских карт и загран паспортов в России
 *
 * @see CharRuToEn::LIST Соответствия символов кириллицы и латиницы
 */
